 ...
 * <p>
 * Extensions annotated {@code @Validation} can define parameters of these types:
 * <ul>
 * <li>{@link cdi.lite.extension.phases.validation.Errors Errors}: to add validation errors</li>
