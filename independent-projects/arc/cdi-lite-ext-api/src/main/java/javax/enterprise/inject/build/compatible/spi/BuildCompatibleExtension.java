 ...
 * <p>
 * CDI implementations are not required to accept custom implementations of any {@code javax.enterprise.lang.model}
 * or {@code javax.enterprise.inject.build.compatible.spi} interface. In other words, users may only use instances
 * of these interfaces that they previously obtained from the corresponding API. If not, non-portable behavior results.
 * <p>
 * In build compatible extensions, implementations of {@link javax.enterprise.lang.model.AnnotationTarget}
