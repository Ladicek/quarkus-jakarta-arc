...
public class BeanDeployment {
    ...
    BeanDeployment(BuildContextImpl buildContext, BeanProcessor.Builder builder) {
        ...
        this.stereotypes = findStereotypes(this.beanArchiveIndex, interceptorBindings, beanDefiningAnnotations, customContexts,
                builder.additionalStereotypes, additionalStereotypes, annotationStore);
    ...
    private Map<DotName, StereotypeInfo> findStereotypes(IndexView index, Map<DotName, ClassInfo> interceptorBindings,
            ...
            Map<DotName, Collection<AnnotationInstance>> legacyAdditionalStereotypes, Set<DotName> additionalStereotypes,
            AnnotationStore annotationStore) {
        ...
        for (Collection<AnnotationInstance> annotations : legacyAdditionalStereotypes.values()) {
        ...
        for (DotName stereotypeName : stereotypeNames) {
            ...
            if (stereotypeClass != null && !isExcluded(stereotypeClass)) {
                ...
                boolean isAdditionalStereotypeBuildItem = legacyAdditionalStereotypes.containsKey(stereotypeName)
                        || additionalStereotypes.contains(stereotypeName);
